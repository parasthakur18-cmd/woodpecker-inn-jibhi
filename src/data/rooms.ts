...
export const rooms: Room[] = [
  ...
  },
  {
    ...
    tagline:
      "A comfortable and welcoming female-only shared dormitory, perfect for solo women travelers exploring the beautiful mountains of Jibhi.",
    description:
    ...
    capacity: "1 Guest per Bed",
    bedType: "1 Bed in a 4-Bed Female Dormitory",
    size: "Female-Only Shared Dormitory",
    startingPrice: "₹699",
    badges: ["Women Only", "Free Wi-Fi", "Shared Bathroom", "Mountain View"],
    features: ["4 bunk beds", "Personal locker", "Reading light", "Shared bathroom", "Women-only floor"],
    highlights: [
      { icon: "users", label: "1 Guest" },
      { icon: "bed", label: "1 Bed in a 4-Bed Female Dormitory" },
      { icon: "mountain", label: "Mountain View" },
      { icon: "wifi", label: "Complimentary High-Speed Wi-Fi" },
      { icon: "bath", label: "Shared Bathroom" },
      { icon: "flame", label: "24×7 Hot & Cold Water" },
