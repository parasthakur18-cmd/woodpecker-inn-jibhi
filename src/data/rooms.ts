...
export const rooms: Room[] = [
  ...
  },
  {
    ...
    tagline: "Relax in a cozy queen room designed for a peaceful mountain getaway in the heart of Jibhi.",
    description:
      "Enjoy a peaceful stay in our Superior Queen Room, thoughtfully designed for couples and travelers looking for comfort and relaxation. Featuring a comfortable queen bed, beautiful mountain views, and essential amenities, this room offers the perfect retreat after exploring the scenic beauty of Jibhi.",
    longDescription:
      "Enjoy a peaceful stay in our Superior Queen Room, thoughtfully designed for couples and travelers looking for comfort and relaxation. Featuring a comfortable queen bed, beautiful mountain views, and essential amenities, this room offers the perfect retreat after exploring the scenic beauty of Jibhi.",
    image: superiorQueenHero.url,
    heroImage: superiorQueenHero.url,
    gallery: [],
    inventory: 1,
    inventoryLabel: "1 Room",
    capacity: "2 Guests",
